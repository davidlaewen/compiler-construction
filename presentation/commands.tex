...
% Iris and sep. logic
\newcommand{\updLE}{\textstyle\upd_{\textsf{le}}}
\newcommand{\leqCtx}{\leq_{\textsf{ctx}}}
\newcommand{\Ctx}{\mathcal{C}}
\newcommand{\toRe}{\to_\textsf{re}}
\newcommand{\reord}{\textsf{re}}
\newcommand{\logic}{\textsf{log}}
% \newcommand{\later}{\mathop{\triangleright}}
% \newcommand{\upd}{\mathop{\dispdot[-0.2ex]{\mid\kern-0.4ex\Rrightarrow\kern-0.25ex}}}
\newcommand{\AU}{\textbf{\sffamily AU}}
\newcommand{\Value}{\textsf{value}}
\newcommand{\interp}[1]{\llbracket #1 \rrbracket}
\newcommand{\WP}{\textsf{wp}}
\newcommand{\pure}{{\textsf{pure}}}
\newcommand{\cred}{\text{\pounds}}
\newcommand{\credSupp}{\mathop{\text{\pounds}_{\!\bullet}}}
