...
instance TraversableStream TokenStream where
  ...
  reachOffset o PosState {..} =
    trace ("Token offset: " ++ show o) $
    trace ("input: " ++ show (tokenStream pstateInput)) $
    trace ("charConsumed: " ++ show charsConsumed) $
    trace ("preStr: " ++ show preStr) $
    trace ("\n\npostStr: " ++ show postStr) $
    trace ("\n\npreLine: " ++ show preLine) $
    trace ("\n\nrestOfLine: " ++ show restOfLine) $
    ...
    where
      ...
      (preStr, postStr) = T.splitAt charsConsumed (tokenStreamInput pstateInput)
