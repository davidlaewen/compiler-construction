...
\todobox{Discuss use of parser combinators, in particular those specific to
the token type, and give some examples.}
...
\haskell{symbolP SymBracketLeft} succeeds, we assume that the user intended to
...
but do not fail outright, allowing \haskell{emptyListP} to succeed despite the
