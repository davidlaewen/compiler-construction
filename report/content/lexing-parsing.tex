...
heavy use of monadic \emph{combinators}, such as \haskell{many} and
\haskell{sepBy} from \haskell{Control.Monad}.
...
functions, or \haskell{optional}, which allows a parser to fail, returning a
